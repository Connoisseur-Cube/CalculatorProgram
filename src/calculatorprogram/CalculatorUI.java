...
public static boolean answered = false;
    ...
    private void initComponents() {
        ...
        setBounds(new java.awt.Rectangle(500, 200, 300, 400));
...
// 2
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        dispText = jTextPane1.getText();
        if(answered){
            dispText = "";
            answered = false;
        }
        jTextPane1.setText(dispText + 2);       
...
// 9
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        dispText = jTextPane1.getText();
        try{
        double answer = Calculation.evaluate(dispText); 
        int check = (int) answer;
        if(check == answer){
            dispText = String.valueOf(check);
        } else
        {
            dispText = String.valueOf(answer);
        }
        }
        catch(Exception e){
            ItsON obj = new ItsON();
            obj.setLabel("Syntax Error or Arithemtic Error");
            obj.setVisible(true);
        }
        answered = true;
        jTextPane1.setText(dispText);
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        dispText = jTextPane1.getText();
        jTextPane1.setText(dispText + 0 + 0);
